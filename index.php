...
<body>
    <header>
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item">
                                <a target="_black" href="https://instagram.com/saojoaodepatos?igshid=YmMyMTA2M2Y="><img src="img/eYx8cP.tif.png"></a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="tamandare-icon">
            <img src="img/icon.balon-svg.svg">
        </div>
    </header>
    <div class="banner">
    ...
    <div class="comprar-btn">
        <a target="_blanck" href="https://www.evenyx.com/sao-joao-de-patos">
